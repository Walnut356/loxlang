...
.seh_proc _ZN5rslox8compiler6Parser6binary17h06bce2c0dc711085E
        ...
        call rslox::compiler::Parser::parse_precedence
                // C:\Coding\Projects\learning\loxlang\rslox\src\compiler.rs : 205
                TokenKind::Minus => self.chunk.push_opcode(OpCode::Subtract, line),
...
.LBB39_5:
        ...
        mov dl, 8
        call rslox::compiler::Parser::parse_precedence
                // C:\Coding\Projects\learning\loxlang\rslox\src\compiler.rs : 207
                TokenKind::Slash => self.chunk.push_opcode(OpCode::Divide, line),
        mov rsi, qword ptr [rsi + 40]
                // C:\Users\ant_b\.rustup\toolchains\stable-x86_64-pc-windows-gnu\lib/rustlib/src/rust\library\alloc\src\vec\mod.rs : 2444
                let len = self.len;
        mov rbx, qword ptr [rsi + 16]
...
.LBB39_16:
        ...
        mov dl, 8
        call rslox::compiler::Parser::parse_precedence
                // C:\Coding\Projects\learning\loxlang\rslox\src\compiler.rs : 206
                TokenKind::Star => self.chunk.push_opcode(OpCode::Multiply, line),
        mov rsi, qword ptr [rsi + 40]
                // C:\Users\ant_b\.rustup\toolchains\stable-x86_64-pc-windows-gnu\lib/rustlib/src/rust\library\alloc\src\vec\mod.rs : 2444
                let len = self.len;
        mov rbx, qword ptr [rsi + 16]
...
.LBB39_19:
        ...
        mov dl, 7
        call rslox::compiler::Parser::parse_precedence
                // C:\Coding\Projects\learning\loxlang\rslox\src\compiler.rs : 204
                TokenKind::Plus => self.chunk.push_opcode(OpCode::Add, line),
        mov rsi, qword ptr [rsi + 40]
                // C:\Users\ant_b\.rustup\toolchains\stable-x86_64-pc-windows-gnu\lib/rustlib/src/rust\library\alloc\src\vec\mod.rs : 2444
                let len = self.len;
        mov rbx, qword ptr [rsi + 16]
